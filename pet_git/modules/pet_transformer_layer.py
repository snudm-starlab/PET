...
class PetTransformerEncoderLayerBase(nn.Module):
    """Encoder layer block.
...
class PetTransformerEncoderLayer(PetTransformerEncoderLayerBase):
...
class PetTransformerDecoderLayerBase(nn.Module):
    """Decoder layer block.
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        if no_encoder_attn:
            ...
            self.encoder_attn = self.build_encoder_attention(self.embed_dim, cfg,q_proj=pre_q_proj)
...
# backward compatible with the legacy argparse format
class PetTransformerDecoderLayer(PetTransformerDecoderLayerBase):
    def __init__(
