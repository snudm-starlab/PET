...
class CommonConfig(FairseqDataclass):
    ...
    ### revised by hyojin
    is_head_selection: bool = field(
        default=False, metadata={"help": "whether to use head selection modules"}
    )
    is_self_enc_q_shuffle: bool = field(
        default=False, metadata={"help": "whether to shuffle decoder query in self_attn and enc_attn"}
    )
    is_dec_kv_shuffle: bool = field(
        default=False, metadata={"help": "whether to shuffle decoder key and value"}
    )
    is_ptp_initializing: bool = field(
        default=False, metadata={"help": "whether to ptp initialized"}
    )
    is_ptp_additional_layer: bool = field(
        default=False, metadata={"help": "whether to add ptp initialization layer"}
    )
    is_mv_pruning: bool = field(
        default=False, metadata={"help": "whether to use movement pruning"}
    )
    is_SPS: bool = field(
        default=False, metadata={"help": "whether to use SPS model"}
    )
    is_WD: bool = field(
        default=False, metadata={"help": "whether to use WD model"}
    )
    is_decoder_CAN: bool = field(
        default=False, metadata={"help": "whether to use CAN model to decoder"}
    )
    is_decoder_SPS: bool = field(
        default=False, metadata={"help": "whether to use SPS model to decoder"}
    )
    is_dec_sharing: bool = field(
        default=False, metadata={"help": "whether to share query matrix"}
    )
    is_dec_shuffle: bool = field(
        default=False, metadata={"help": "whether to shuffle query and key in self-attn"}
    )
    is_dec_self_attn_shuffle: bool = field(
        default=False, metadata={"help": "whether to shuffle query and key in self-attn"}
    )
    is_dec_enc_attn_shuffle: bool = field(
        default=False, metadata={"help": "whether to shuffle query and key in enc-attn"}
    )
    is_stacked_type: int = field(
        default=0, metadata={"help": "define how to stack and shuffle layers"}
    )
    is_ptp_label: bool = field(
        default=False, metadata={"help": "whether to use ptp label (predict 4 classes, change output shape"}
    )
    ###
...
class CheckpointConfig(FairseqDataclass):
    ###
    teacher_dir: str = field(
        default="checkpoints_pkd", metadata={"help": "path to load teacher checkpoints_pkd"}
    )
    ###
    save_dir: str = field(
        default="checkpoints_pkd", metadata={"help": "path to save checkpoints_pkd"}
    )
    ...
    keep_interval_updates: int = field(
        default=-1,
        metadata={
            "help": "keep the last N checkpoints_pkd saved with --save-interval-updates"
        },
    )
    keep_interval_updates_pattern: int = field(
        ...
        metadata={
            ...
            "any checkpoints_pkd with update X where "
            "X %% keep_interval_updates_pattern == 0"
        },
    )
    keep_last_epochs: int = field(
        default=-1, metadata={"help": "keep last N epoch checkpoints_pkd"}
    )
    keep_best_checkpoints: int = field(
        default=-1, metadata={"help": "keep best N checkpoints_pkd based on scores"}
    )
    no_save: bool = field(
        default=False, metadata={"help": "don't save models or checkpoints_pkd"}
    )
    no_epoch_checkpoints: bool = field(
        default=False, metadata={"help": "only store last and best checkpoints_pkd"}
    )
    no_last_checkpoints: bool = field(
        default=False, metadata={"help": "don't store last checkpoints_pkd"}
    )
    ...
    best_checkpoint_metric: str = field(
        default="loss", metadata={"help": 'metric to use for saving "best" checkpoints_pkd'}
    )
    maximize_best_checkpoint_metric: bool = field(
        default=False,
        metadata={
            "help": 'select the largest metric value for saving "best" checkpoints_pkd'
        },
    )
    patience: int = field(
        default=-1,
    ...
    load_checkpoint_on_all_dp_ranks: bool = field(
        default=False,
        metadata={
            "help": "load checkpoints_pkd on all data parallel devices "
    ...
    write_checkpoints_asynchronously: bool = field(
        ...
        metadata={
            "help": (
                "Write checkpoints_pkd asynchronously in a separate "
