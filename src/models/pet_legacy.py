...
from .pet_transformer_base import (
    PetTransformerModelBase
)


@register_model("pet")
class PetTransformerModel(PetTransformerModelBase):
    """
    Pet Transformer model with Transformer Configuration
    """
...
# architectures
@register_model_architecture("pet", "pet")
...
@register_model_architecture("pet", "pet_iwslt_de_en")
def pet_iwslt_de_en(args):
    ...
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 480)
