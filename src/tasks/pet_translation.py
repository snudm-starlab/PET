...
@dataclass
class PetTranslationConfig(FairseqDataclass):
...
@register_task("pet_translation", dataclass=PetTranslationConfig)
class PetTranslationTask(FairseqTask):
    """
    ...
    cfg: PetTranslationConfig

    def __init__(self, cfg: PetTranslationConfig, src_dict, tgt_dict):
        super().__init__(cfg)
        self.src_dict = src_dict
        self.tgt_dict = tgt_dict

    @classmethod
    def setup_task(cls, cfg: PetTranslationConfig, **kwargs):
    ...
    def train_step_kd(
            self, sample, model, criterion, optimizer, update_num, teacher_model=None, ignore_grad=False
    ):
        """
        ...
        Args:
            ...
            model (~fairseq.models.BaseFairseqModel): the teacher model
    ...
    def _inference_with_bleu(self, generator, sample, model):
        ...
        if self.cfg.eval_tokenized_bleu:
            return bleu.corpus_score(hyps, [refs], tokenize="none")
        else:
